...
namespace GeneticRim
{
    public class DeathActionWorker_SmallBomb : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse, Lord lord)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, DamageDefOf.Bomb, corpse.InnerPawn, -1,-1,null, null, null, null, ThingDef.Named("Filth_Blood"), .7f, 1,null, false, null, 0f, 1);
        }
