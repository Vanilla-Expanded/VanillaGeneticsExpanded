...
namespace GeneticRim
{
    class DeathActionWorker_HairballExplosion : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse, Lord lord)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, Named("GR_HairballExplosion"), corpse.InnerPawn, 1, -1, SoundDef.Named("Explosion_Bomb"), null, null, null, ThingDef.Named("GR_Hairballs"), 1f, 1, null, false, null, 0f, 1);
        }
