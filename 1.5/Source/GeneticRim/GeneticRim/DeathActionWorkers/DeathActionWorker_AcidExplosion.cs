...
namespace GeneticRim
{
    public class DeathActionWorker_AcidExplosion : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse, Lord lord)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, InternalDefOf.GR_Acid, corpse.InnerPawn, 10, -1, InternalDefOf.GR_Pop, null, null, null, ThingDef.Named("Filth_Fuel"), 0.3f, 1,null, false, null, 0f, 1);
        }
