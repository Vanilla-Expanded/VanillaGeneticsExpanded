...
namespace GeneticRim
{
    public class DeathActionWorker_FrostExplosion : DeathActionWorker
    {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, DamageDefOf.Frostbite, corpse.InnerPawn, 10,-1,SoundDef.Named("Explosion_Bomb"), null, null, null, ThingDef.Named("GR_Gas_Ice"), 1f, 1,null, false, null, 0f, 1);
            }
