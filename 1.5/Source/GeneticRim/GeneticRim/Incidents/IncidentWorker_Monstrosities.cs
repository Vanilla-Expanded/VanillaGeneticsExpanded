...
namespace GeneticRim
{
    public class IncidentWorker_Monstrosities : IncidentWorker
    {
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            hybridsList.TryRandomElementByWeight((PawnKindDef a) => AggressiveAnimalIncidentUtility.AnimalWeight(a, parms.points), out firstPawn);
            ...
            if (firstPawn != null)
            {
                ...
                while (totalPoints>0)
                {
                    ...
                    hybridsList.TryRandomElementByWeight((PawnKindDef a) => AggressiveAnimalIncidentUtility.AnimalWeight(a, totalPoints), out nextPawn);
