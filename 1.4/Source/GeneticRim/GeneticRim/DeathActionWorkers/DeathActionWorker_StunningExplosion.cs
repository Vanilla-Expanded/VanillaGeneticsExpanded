...
namespace GeneticRim
{
    public class DeathActionWorker_StunningExplosion : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, DamageDefOf.Stun, corpse.InnerPawn, -1,-1,null, null, null, null, ThingDef.Named("Gas_Smoke"), .7f, 1,null, false, null, 0f, 1);
        }
