...
namespace GeneticRim
{
    class CompExploder : ThingComp
    {
        ...
        public void Explode()
        {
            ...
            GenExplosion.DoExplosion(this.parent.Position, this.parent.Map, this.Props.explosionForce, DamageDefOf.Flame, this.parent, -1,-1,null,null, null, null, null, 0f, 1,null, false, null, 0f, 1);
