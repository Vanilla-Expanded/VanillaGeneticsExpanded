...
namespace GeneticRim
{
    public static class ArchotechCountdown
    {
        ...
        private static void CountdownEnded()
        {
            ...
            PawnGenerationRequest request = new PawnGenerationRequest(InternalDefOf.GR_ArchotechCentipede, Faction.OfPlayer, PawnGenerationContext.NonPlayer, 
               -1, false, true, false, false, true, 0f,false, true, false, true, true, false, false);
