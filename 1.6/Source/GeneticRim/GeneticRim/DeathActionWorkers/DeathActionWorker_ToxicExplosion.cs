...
namespace GeneticRim
{
    public class DeathActionWorker_ToxicExplosion : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse, Lord lord)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, Named("GR_ToxicExplosion"), corpse.InnerPawn, 1, -1, SoundDef.Named("Explosion_Bomb"), null, null, null, ThingDef.Named("GR_Poison_Gas"), 1f, 1, null, null, 255, false, null, 0f, 1);
        }
