        ...
        protected override void Tick()
        {
            ...
            if (progress >= 0)
            {
                ...
                if (progress >= 1)
                {
                    ...
                    if (innerPawn.playerSettings != null && innerPawn.playerSettings.AreaRestrictionInPawnCurrentMap != null)
                    {
                        pawn.playerSettings.AreaRestrictionInPawnCurrentMap = innerPawn.playerSettings.AreaRestrictionInPawnCurrentMap;
                    }
                    ...
                    if (unSpentFuse != null) { 
                        ...
                        GenExplosion.DoExplosion(unSpentFuse.Position, this.Map, 2.9f, DamageDefOf.Flame, this, -1, -1, null, null, null, null, null, 0f, 1, null, null, 255, false, null, 0f, 1);
                    }
