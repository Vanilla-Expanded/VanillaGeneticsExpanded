...
namespace GeneticRim
{
    public class HediffComp_Exploder : HediffComp
    {
        ...
        public override void Notify_PawnDied(DamageInfo? dinfo, Hediff culprit = null)
        {
            ...
            GenExplosion.DoExplosion(this.parent.pawn.Corpse.Position, this.parent.pawn.Corpse.Map, explosionForce, DamageDefOf.Flame, this.parent.pawn.Corpse, -1, -1, null, null, null, null, null, 0f, 1, null, null, 255, false, null, 0f, 1);
